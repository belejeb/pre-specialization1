                        ...
                        <div class="card">
                            <div class="header">
                              <?php   include("../../database/Connection.php");
                                ...
                                $sql="Call spBuscarMedicamento('$nombre')";

                                if ($result = $conn->query($sql))
                                {
                                  echo "<script>alert('Medicamentos encontrados'); </script>";
                              ...
                              {
                                   echo"<tr><td>$info[0]</td><td>$info[1]</td><td>$info[2]</td><td><img src='../../files/".$info[3]."' ></td><td>$info[4]</td</tr>";
                              }
                              ...
                              $conn-> close(); ?>
                                  ...
                                  <a href="medicamento.html">Regresar</a>
