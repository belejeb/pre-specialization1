...
function iniciar()
{
	...
	document.getElementById("btn_play_pause").addEventListener("click", play_pause, false);
...
function cambiar_volumen(tipo)
{
	...
	else if (tipo == 2)//Bajar volumen
	{
		document.getElementById("audio_track").volume = document.getElementById("audio_track").volume - (numero / 100);
	}
	else if (tipo == 3)//Bajar volumen
	{
...
function pruebas()
{
	alert(document.getElementById("audio_track").volume / 1);
}
